...
public abstract class BaseChart extends ViewGroup {
    ...
    protected BaseChart(Context context) {
        ...
        mLegendHeight   = ViewUtils.dpToPx(DEF_LEGEND_HEIGHT);
        mLegendTextSize = ViewUtils.dpToPx(DEF_LEGEND_TEXT_SIZE);
    ...
    public BaseChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mLegendHeight       = a.getDimension(R.styleable.BaseChart_egLegendHeight,     ViewUtils.dpToPx(DEF_LEGEND_HEIGHT));
            mLegendTextSize     = a.getDimension(R.styleable.BaseChart_egLegendTextSize,   ViewUtils.dpToPx(DEF_LEGEND_TEXT_SIZE));
    ...
    public void setLegendHeight(float _legendHeight) {
        mLegendHeight = ViewUtils.dpToPx(_legendHeight);
    ...
    public void setLegendTextSize(float _legendTextSize) {
        mLegendTextSize = ViewUtils.dpToPx(_legendTextSize);
    }
    ...
    protected float             mLegendTopPadding = ViewUtils.dpToPx(4.f);
