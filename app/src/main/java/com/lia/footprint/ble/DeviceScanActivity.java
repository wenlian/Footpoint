...
import com.lia.footprint.ble.BluetoothClass.OnServiceDiscoverListener;
...
public class DeviceScanActivity extends ListActivity {
     ...
     * 搜索到BLE终端服务的事件
     */
    private BluetoothClass.OnServiceDiscoverListener mOnServiceDiscover = new OnServiceDiscoverListener(){
     ...
     * 收到BLE终端数据交互的事件
     */
    private BluetoothClass.OnDataAvailableListener mOnDataAvailable = new OnDataAvailableListener(){
