...
public class ValueLineSeries {
    ...
    public void setLeftOffset(float mLeftOffset) {
    ...
    public void setRightOffset(float mRightOffset) {
    ...
    //the left space should leave for first element
    private float                   mLeftOffset;

    //the right space should leave for last element
